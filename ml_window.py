...
from ml_conf import ML_NODES
from ml_drag_listbox import QDMDragListbox
from ml_sub_window import MlSubWindow
...
class MlWindow(NodeEditorWindow):

    def initUI(self):
        self.name_company = 'ARA'
        self.name_product = 'Easy ML Editor'
    ...
    def createMdiChild(self, child_widget=None):
        nodeeditor = child_widget if child_widget is not None else MlSubWindow()
