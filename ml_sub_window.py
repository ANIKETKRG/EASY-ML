...
from ml_conf import ML_NODES, get_class_from_opcode, LISTBOX_MIMETYPE
...
class MlSubWindow(NodeEditorWidget):
    def __init__(self):
        super().__init__()
    ...
    def onDrop(self, event):
        if event.mimeData().hasFormat(LISTBOX_MIMETYPE):
            ...
            try:
                print(f"opcode is {op_code}, class is {get_class_from_opcode(op_code)}")
